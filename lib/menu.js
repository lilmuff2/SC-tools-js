...
class Menu {
  constructor() {
    ...
    otherCategory.items.push(
      new Item({
        ...
        description: locale_1.locale.format(
          locale_1.locale.changeLanguage_description,
          [config_1.config.language]
        ),
    ...
    otherCategory.items.push(
      new Item({
        ...
        description:
          locale_1.locale.changeCompression_description +
          ["NONE", "LZMA", "FAST_LZMA"][config_1.config.defaultCompression],
  ...
  printFeature(id, name, description = undefined, width = -1) {
    ...
    if (description) {
      text +=
        " ".repeat(Math.floor(width / 2) - text.length) + ": " + description;
    }
  ...
  choice() {
    ...
    (0, console_1.trace)(locale_1.locale.xcoderHeader, {
      ...
      bgColor: console_1.bgColors.black,
    ...
    for (
      let categoryIndex = 0;
      this.categories.length > categoryIndex;
      categoryIndex++
    ) {
