const { SupercellSWF, MovieClip } = require("supercell-swf");
...
function tojson() {
  ...
  print(
    locale_1.locale.format(locale_1.locale.LoadingTook, hrtime(time)),
    false,
    colours.fg.black,
    colours.bg.green
  );
  ...
  if (hrtime(time) < 1) {
    print(
      locale_1.locale.format(locale_1.locale.LoadingJson, hrtime(time)),
      false,
      colours.fg.black,
      colours.bg.green
    );
...
function toSc() {
  ...
  print(
    locale_1.locale.format(locale_1.locale.LoadingSc, hrtime(time)),
    false,
    colours.fg.black,
    colours.bg.green
  );
