...
class Config {
    ...
    selectCompression() {
        this.defaultCompression = [COMPRESSION.FAST_LZMA,COMPRESSION.LZMA,COMPRESSION.NONE][selectFromArray(["FAST_LZMA","LZMA","NONE"],["Fast but bigger file size","Slow but small file size","No compression(Game will crush)"])]
        this.dump();
    }
    dump() {
